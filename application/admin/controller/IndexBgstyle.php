...
use think\Config;
use think\Db;
class IndexBgstyle extends Common
{
    var $model;
    function _initialize() {
        $this->model ='IndexBgstyle';//本控制器下的表名称
        parent::_initialize ();
    }
    ...
    public function deleteAll()
    {
        ...
        db($model)->execute('truncate ' . $prefix . $model);
        $this->success('删除成功');
    }
